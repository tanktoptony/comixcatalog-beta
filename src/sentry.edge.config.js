// Sentry Edge runtime initialization — middleware and any edge-runtime route handlers.
// Loaded by src/instrumentation.js's register() hook when NEXT_RUNTIME === "edge".
//
